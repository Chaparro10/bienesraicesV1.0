function eventListener(){document.querySelector(".mobile-menu").addEventListener("click",navegacionRes)}function navegacionRes(){const e=document.querySelector(".navegacion");e.classList.contains("mostrar")?e.classList.remove("mostrar"):e.classList.add("mostrar")}
